...
//routes
app.get("/", async function(req, res){ //makes asyunchronous code
    //waits for the synchronous code 
...
function getImages(keyword) {
    ...
    request('https://pixabay.com/api/?key=13831354-d4a3a65cf672bdaceb3d354f1&q='+keyword, 
